...
# --- CHANGED: Using standard LangChain classes for Direct OpenAI ---
...
class AgentDecisoinConfig:
    def __init__(self):
        # --- CHANGED: Using ChatOpenAI with Direct OpenAI parameters ---
        self.llm = ChatOpenAI(
            model = os.getenv("model_name"), # Model name from .env (e.g., gpt-4o)
...
class RAGConfig:
    def __init__(self):
        ...
        # --- CHANGED: Initialize Direct OpenAI Embeddings ---
        self.embedding_model = OpenAIEmbeddings(
            model = os.getenv("embedding_model_name"), # Model name from .env (e.g., text-embedding-ada-002)
            openai_api_key = os.getenv("embedding_openai_api_key") # Key from .env
        )
